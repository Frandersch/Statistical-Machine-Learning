...
\begin{document}
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[only marks, mark=-,draw=red,mark size=0.3cm,line width=2pt]coordinates {(5,4) (4.5,5.2) (5,6.3) (3,5.8) (7,4) (7,5.5)};
			...
			\addplot [smooth,tension=1,no markers] coordinates {(2.1,6) (5,6.7) (8,5.9) (7,3.5) (4,3.8)(3.5,5.1)\closedcycle};
		\end{axis}
	\end{tikzpicture}
\end{document}