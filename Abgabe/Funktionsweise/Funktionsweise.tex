...
\end{align} wobei \(d\) ein Integer Die Verwendung von diesem Kernel
fuührt dazu, dass die Entscheidungsgrenze sich ähnlich Verhält, wie als
würde man zu Beginn eine Merkmalserweiterung mit Polynomen vom Grad
\(d\) durchführen. Eine weitere Kernel Funktion ist der Radiale Kernel
mit der Form \begin{align}
...
größeren Einfluss haben. Es gibt noch einen Reihe wietere Kernel, die
auf unterschiedlichen Ähnlichkeitsmaßen beruhen, aber eher seltener oder
nur in speziellen Zusammenhänge angewendet werden.
