...
Die Separierung von Datenklassen wird allgemein als Klassifikation
beschrieben. Dabei bieten SVM eine große Anzahl an
Anwendungsmöglichkeiten, wie beipielsweise, die Zuordnung von Bildern,
in der Bioinformatik (Krebs)
