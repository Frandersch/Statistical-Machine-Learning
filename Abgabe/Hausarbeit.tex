...
normierten \(\overline{\beta}\)-Vektor Projezieren, dann erhält man für
alle diese Projektionen den selben Wert \(c\). Also gilt für alle
Punkte, die auf der Ebene liegen. \begin{align}
...
eingeführt. Wie dieser sich auswirkt ist in Abbildunt
\ref{fig:slackvariable} aufgeführt.
\parencite{jamesIntroductionStatisticalLearning2021}. Setzt man diese in
diese in \eqref{eq:Nebenbedingung} lautet die neuen Nebenbedingung
\begin{align}
...
Dieses Maximierungsproblem wird dann genauso aufgelöst wie bei dem Hard
Margin Classifier und die Entscheidungsregel ist ebenfalls gleich. Erst
durch den einsatz dieser Technik wurde von der Methode auch wirklich als
Support Vector Machine gesprochen
...
die eine Ausprägung der Zielvariable (\(y_i=1\)) und dementsprechen
...
zwar nicht direkt, da hier im Ranking über alle Szenarien mir radialer
