...
Die Separierung von Datenklassen wird allgemein als Klassifikation beschrieben. Dabei bieten SVM eine große Anzahl an Anwendungsmöglichkeiten, wie beipielsweise, die Zuordnung von Bildern, in der Bioinformatik (Krebs)

Die Grundlage für eine optimal separierende Hyperebene wurde bereits 1964 von Alexej Chervonenkis und Vladimir Vapnik gelegt und die Methode wurde anschließend von mehreren Autoren stetig erweitert \parencite{vapnikEstimationDependencesBased2006}. Seitdem ist ihre Leistung, trotz großer Fortschritte im Bereich neuronaler Netze, vor allem im Bereich binärer Klassifikationprobleme unumstritten und sie gelten hier als eine der meistgenutzten Methoden \parencite{soofiClassificationTechniquesMachine2017}.
