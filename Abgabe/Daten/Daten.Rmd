...
\end{align*}
diese Form der Trennung stellt also eine Merkmalserweiterung um quadratische Terme dar und funktioniert damit ähnlich wie eine SVM mit polynomialen Kernel mit $d=2$.Die Verschiebung erflogte hier nur durch skalierung der Werte von $X_p$ ebenfalls mit $k\sim\mathcal{N}(\mu_k,\sigma^2_k)$ für die eine Ausprägung und $k\sim\mathcal{N}(-\mu_k,\sigma^2)$ für die andere Ausprägung.\newline 
