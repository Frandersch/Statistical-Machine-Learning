...
```{r S1ROC, echo=FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height=5, fig.cap="ROC-Kurven Szenario 1",fig.align='center'}
library(pROC)
...
```{r S2ROC, echo=FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height=5, fig.cap="ROC-Kurven Szenario 2",fig.align='center'}
library(pROC)
...
```{r S3ROC, echo=FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height=5, fig.cap="ROC-Kurven Szenario 3",fig.align='center'}
library(pROC)
